      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-6 md:mb-8 max-w-md">
            Introducing Med-A Health AI: A medical revolution to streamline patient care, improve outcomes, and facilitate communication between clinicians and healthcare systems.
          </p>

          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 md:gap-4 mb-8 md:mb-12">
            <button className="bg-gray-900 text-white px-6 py-3.5 rounded-full text-sm font-semibold hover:bg-gray-800 transition-colors flex items-center justify-center gap-2">
              Join the Private Beta
              <ArrowRight className="w-4 h-4" />
            </button>
            <button className="bg-white text-gray-900 px-6 py-3.5 rounded-full text-sm font-semibold hover:bg-gray-50 transition-colors border border-gray-200">
              Watch Demo
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 relative">
          {/* Top Left Card - Doctor Consultant Placeholder */}
          ...
          {/* Top Right Card - Doctor with Patient */}
          ...
          {/* Bottom Left Card - Blue EMR Card */}
          ...
          {/* Bottom Right Card - Purple Card with Person */}
          <div className="bg-gradient-to-br from-purple-600 to-fuchsia-500 rounded-2xl md:rounded-3xl overflow-hidden aspect-square relative">
            ...
            <div className="absolute bottom-4 md:bottom-6 left-4 md:left-6 right-4 md:right-6 bg-white rounded-xl md:rounded-2xl p-3 md:p-4 shadow-lg">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <div className="flex-1 h-1.5 md:h-2 bg-gray-200 rounded-full"></div>
              </div>
            </div>
          </div>
        </div>
